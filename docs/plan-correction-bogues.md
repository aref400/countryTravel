...
- **Commit** : [`1abd088`] — _Correction si le JSON n'est pas valide, pour éviter de faire planter l'app_
...
- **Commit** : [`f5e46bb`] — _Correction du token pas mis dans le localStorage_
...
- **Commit** : [`c7f42a0`] — _Correction du retour arrière au clique sur un pays depuis le formulaire_
...
- **Commit** : [`49d66e8`] — _Fix 404 error when accessing non-homepage URLs on website_
...
- **Commit** : [`f89983d`] — _Correction de la pipeline_
...
- **Commit** :[`1c75d3c`] _Ajout page 404_
...
- **Commit** :[`4c0f7b4`] _fix aligner le mesage du mot de passe a la regle_
...
- **Commit** :[`7d84c9c`] _Packages shared retirer + documentation faite_
...
- **Commit** :[`5ee80e4`] _Modification de la modale pour afficher quand la sauvegarde a eu lieu_
...
- **Commit** :[`82b90b0`] _Correction du bug liée au refreshToken pas sauvegardé côté front_
